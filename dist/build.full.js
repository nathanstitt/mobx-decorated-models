...
function readonlyPrimitive() {
    var defaultSerial = serializr.primitive();
    return {
...
var SimpleHandlers = {
    identifier: function identifier$$1() {
        return serializr.identifier();
    },
    field: function field() {
        return serializr.primitive();
    },
...
var AsyncHandlers = {
    hasMany: function hasMany(model) {
        return serializr.list(serializr.object(model));
    },
    belongsTo: function belongsTo(model) {
        return serializr.object(model);
    }
};
